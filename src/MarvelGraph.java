...
public class MarvelGraph {
    ...
    public static void main(String[] args){
        ...
        //collaborationMatrix(ch);

        //for (int i=0; i < x; i++)
            System.out.println(ch[x-1].getName() + " has a Spider Man number of " + ch[x-1].spiderNum);

        System.out.println("\nIt took " + accesses + " vertex accesses to compute every Spider Man number for the entire matrix.");
    ...
    public static int computeSpiderNum(Characters[] ch){
        ...
        int i=0;
        while (!found) // set spiderman's spider number to zero.
        {
        ...
        ArrayList<Characters> numberOne = new ArrayList<Characters>(); // stores everyone with a spiderman number of 1
        ...
        for (i = 0; i < ch.length-1; i++) // calculate everyone who has a spiderman number of 1.
        {
            for (int j=0; j < ch[i].comics.length; j++)
            {
                ...
                {
                    ch[i].spiderNum = 1; // this character is in a comic with Spider Man.
                    numberOne.add(ch[i]);
                    break;
                }
                accesses++;
        ...
        ArrayList<Characters> numberTwo = new ArrayList<Characters>(); // stores everyone with a spiderman number of 2
        for (i = 0; i < ch.length-1; i++)
        {
            if (ch[i].spiderNum == -1)
            {
                for (int j = 0; j < ch[i].comics.length; j++)
                {
                    ...
                    {
                        for (int k=0; k < numberOne.size(); k++)
                        {
                            if (numberOne.get(k).comics[j] == true)
                            {
                                ch[i].spiderNum = 2;
                                numberTwo.add(ch[i]);
                                break;
        ...
        ArrayList<Characters> numberThree = new ArrayList<Characters>(); // stores everyone with a spiderman number of 3
        for (i = 0; i < ch.length-1; i++)
        {
            if (ch[i].spiderNum == -1)
            {
                for (int j = 0; j < ch[i].comics.length; j++)
                {
                    if (ch[i].comics[j] == true  && i != j)
                    {
                        for (int k=0; k < numberTwo.size(); k++)
                        {
                            if (numberTwo.get(k).comics[j] == true)
                            {
                                ch[i].spiderNum = 3;
                                numberThree.add(ch[i]);
                                break;
                            }
                        }
                    }
        ...
        ArrayList<Characters> numberFour = new ArrayList<Characters>(); // stores everyone with a spiderman number of 3
        for (i = 0; i < ch.length-1; i++)
        {
            if (ch[i].spiderNum == -1)
            {
                for (int j = 0; j < ch[i].comics.length; j++)
                {
                    if (ch[i].comics[j] == true  && i != j)
                    {
                        for (int k=0; k < numberThree.size(); k++)
                        {
                            if (numberThree.get(k).comics[j] == true)
                            {
                                ch[i].spiderNum = 4;
                                numberFour.add(ch[i]);
                                break;
